...
data = json.dumps({"prompt": "Q: What is the html code for a red button?", "max_tokens": 100, 'temperature':0.1, 'top_p':1, 'frequency_penalty':0, 'presence_penalty':0, 'stop':'?', 'n':1})
